    ...
    %{
      ...
      checks: %{
        enabled: [
          ...
          # by the primary level (`Tempo.Ecto.Interval` → `Interval`) is
          # the house style — it keeps call sites reading as domain verbs
          # rather than fully-qualified paths. `excluded_lastnames` keeps
          # names that would shadow an Elixir/Erlang built-in fully
          # qualified — aliasing those to the bare name silently captures
          # the stdlib module.
          ...
          # Disabled: inline TODO/FIXME tags are intentional pointers, not
          # debt for Credo to flag.
